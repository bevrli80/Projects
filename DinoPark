...
#Program to know how much to charge customers who plan on having parties at Ogden's Dinosaur Park
...
while choice < 4:
    ...
    if (choice == 1):
        print(
            "By reserving a group party slot of 10 or more people your group will be admitted to the Park at the group discount rate."
        )
...
#2 Bare Bones
    if (choice == 2):
        ...
        add = int(
            input(
                "Will there be more than 12 people? Press 1 for Yes and 2 for No: "
            ))
        if (add == 1):
